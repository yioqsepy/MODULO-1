...
**Fecha:** 2025  
**Asistente IA utilizado:** desde LMArena he utilizado claude-opus-4.6-thimking (Anthropic)
...
**PROMPT:** 
ROL: eres un experto programador en python 
...
**2 PROMPT:**
añade un boton "Ejecutar Biblioteca" antes del boton "Ver el Código", que ejecute el sistema de gestion de Biblioteca

**RESULTADO:**
Genera el boton "Ejecutar Biblioteca"
y se ejecuta el programa de Bibliioteca.

Funciona correctamente. He creado un nuevo libro: El Libro gordo de petete, y he realizado prestamos y devoluciones.
